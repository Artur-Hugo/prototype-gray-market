...
import br.com.devoliga.services.ClienteService;
...
public class ClienteController {
	...
	@PostMapping
	public ResponseEntity<Cliente> postCliente(@Valid @RequestBody ClienteNewDTO ClienteDto){
		 Cliente obj = service.fromDTO2(ClienteDto);
		 obj = service.insert(obj); 
		return ResponseEntity.status(HttpStatus.CREATED).body(clienteRepository.save(obj));
	}
	@PutMapping
